    ...
    <div>
      ...
      <ul>
        <li>
          Bus:
          <ul>
            <li>One Way: ${ticketFares.bus.oneWay}</li>
            <li>Round Trip: ${ticketFares.bus.roundTrip}</li>
            Stops:
              <ul>
                {ticketFares.bus.stops.map(stop => (
                  <li key={stop.name}>{stop.name}: ${stop.price}</li>
                ))}
              </ul>
          </ul>
        </li>
        <li>
          Subway:
          <ul>
            <li>One Way: ${ticketFares.subway.oneWay}</li>
            <li>Round Trip: ${ticketFares.subway.roundTrip}</li>
            Stops:
              <ul>
        ...
        <li>
          Commuter Rail:
          <ul>
            <li>One Way: ${ticketFares.commuterRail.oneWay}</li>
            <li>Round Trip: ${ticketFares.commuterRail.roundTrip}</li>
            Stops:
              <ul>
        ...
        <li>
          Ferry:
          <ul>
            <li>One Way: ${ticketFares.ferry.oneWay}</li>
            <li>Round Trip: ${ticketFares.ferry.roundTrip}</li>
            <li>
              Stops:
              <ul>
                {ticketFares.ferry.stops.map(stop => (
                  <li key={stop.name}>{stop.name}: ${stop.cost}</li>
                ))}
              </ul>
            </li>
          </ul>
